 ...
 *
 * <p>
 * Possible event types are defined in {@link EventType} enum and include:
 * PAGE_VIEW, USER_ACTION, ERROR, FORM_SUBMIT, API_CALL, PERFORMANCE,
 * FEATURE_USAGE, USER_PREFERENCE, SEARCH, AUTHENTICATION.
 * </p>
 *
 * <p>
 * Example usage:
...
public class BaseEvent {
  ...
  /**
   * Builder class for {@link BaseEvent}.
   * Provides a fluent API for constructing {@link BaseEvent} instances.
   */
